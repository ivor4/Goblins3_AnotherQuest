...
namespace Gob3AQ.VARMAP.Initialization
{
    public sealed class VARMAP_DataSystem : VARMAP
    {
        ...
        private static void InitializeDataSystem()
        {
            ...
            DATA[(int)VARMAP_Variable_ID.VARMAP_ID_PICKABLE_ITEM_OWNER] = new VARMAP_SafeArray<CharacterType>(VARMAP_Variable_ID.VARMAP_ID_PICKABLE_ITEM_OWNER, 3, true, VARMAP_parsers.CharacterType_ParseFromBytes, VARMAP_parsers.CharacterType_ParseToBytes, null);
