...
namespace Gob3AQ.ResourceDialogsAtlas
{
    public static class ResourceDialogsAtlasClass
    {
        ...
        private static readonly DialogConfig[] _DialogConfig = new DialogConfig[(int)DialogType.DIALOG_TOTAL]
        {
            ...
            new DialogOption[4]{DialogOption.DIALOG_CLOWN_EXTRAPERLO_OPTION_0, DialogOption.DIALOG_CLOWN_EXTRAPERLO_OPTION_1, DialogOption.DIALOG_CLOWN_EXTRAPERLO_OPTION_2, DialogOption.DIALOG_FIK_1_OPTION_3}
            ),
            ...
            new DialogOption[2]{DialogOption.DIALOG_SILVANA_EXTRAPERLO_OPTION_0, DialogOption.DIALOG_SILVANA_EXTRAPERLO_OPTION_1}
            ),
        ...
        private static readonly PhraseConfig[] _PhraseConfig = new PhraseConfig[(int)DialogPhrase.PHRASE_TOTAL]
        {
            ...
            new(0,GameSound.SOUND_PHRASE_DIALOG_SILVANA_EXTRAPERLO_OPTION_0_0, new AnimationTrigger[3]{AnimationTrigger.ANIMATION_TRIGGER_TALK,AnimationTrigger.ANIMATION_TRIGGER_STEADY,AnimationTrigger.ANIMATION_TRIGGER_NONE}), /* PHRASE_DIALOG_SILVANA_EXTRAPERLO_OPTION_0_0 */ 
            ...
            new(0,GameSound.SOUND_PHRASE_DIALOG_SILVANA_EXTRAPERLO_OPTION_0_2, new AnimationTrigger[3]{AnimationTrigger.ANIMATION_TRIGGER_TALK,AnimationTrigger.ANIMATION_TRIGGER_STEADY,AnimationTrigger.ANIMATION_TRIGGER_NONE}), /* PHRASE_DIALOG_SILVANA_EXTRAPERLO_OPTION_0_2 */ 
            ...
            new(0,GameSound.SOUND_PHRASE_DIALOG_SILVANA_EXTRAPERLO_OPTION_1_0, new AnimationTrigger[3]{AnimationTrigger.ANIMATION_TRIGGER_TALK,AnimationTrigger.ANIMATION_TRIGGER_STEADY,AnimationTrigger.ANIMATION_TRIGGER_NONE}), /* PHRASE_DIALOG_SILVANA_EXTRAPERLO_OPTION_1_0 */ 
            ...
            new(0,GameSound.SOUND_PHRASE_DIALOG_SILVANA_EXTRAPERLO_INTRO_1, new AnimationTrigger[3]{AnimationTrigger.ANIMATION_TRIGGER_TALK,AnimationTrigger.ANIMATION_TRIGGER_STEADY,AnimationTrigger.ANIMATION_TRIGGER_NONE}), /* PHRASE_DIALOG_SILVANA_EXTRAPERLO_INTRO_1 */ 
