...
namespace Gob3AQ.VARMAP.Types
{
    ...
    public enum GameEvent
    {
        ...
        EVENT_PIPE_OBSERVATION_2, 
        EVENT_COCKROACH_SCARED, 
        EVENT_VALVE_BOX_NEED_OPEN, 
        EVENT_ITEM_HIVE1_SHOELACE_PICKABLE_TAKEN, 
        EVENT_VALVE_BOX_OPENED, 
        EVENT_HIVE1_VALVE_ACTIVATED, 
        EVENT_TALKED_ARTURO_HALL_INN_COMPLETED, 
        EVENT_TALKED_ARTURO_HALL_PUB, 
        EVENT_LAST, 
