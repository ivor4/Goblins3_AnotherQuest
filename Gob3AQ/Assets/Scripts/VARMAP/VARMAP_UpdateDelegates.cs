...
namespace Gob3AQ.VARMAP.Initialization
{
    public sealed class VARMAP_Initialization : VARMAP
    {
        ...
        public static void UpdateDelegates()
        {
            ...
            _GET_ELEM_UNLOCKED_MEMENTO = ((VARMAP_Variable_Interface<MultiBitFieldStruct>)DATA[(int)VARMAP_Variable_ID.VARMAP_ID_UNLOCKED_MEMENTO]).GetListElem;
            _GET_SHADOW_ELEM_UNLOCKED_MEMENTO = ((VARMAP_Variable_Interface<MultiBitFieldStruct>)DATA[(int)VARMAP_Variable_ID.VARMAP_ID_UNLOCKED_MEMENTO]).GetShadowListElem;
            _SET_ELEM_UNLOCKED_MEMENTO = ((VARMAP_Variable_Interface<MultiBitFieldStruct>)DATA[(int)VARMAP_Variable_ID.VARMAP_ID_UNLOCKED_MEMENTO]).SetListElem;
            _GET_SIZE_UNLOCKED_MEMENTO = ((VARMAP_Variable_Interface<MultiBitFieldStruct>)DATA[(int)VARMAP_Variable_ID.VARMAP_ID_UNLOCKED_MEMENTO]).GetListSize;
            _GET_ARRAY_UNLOCKED_MEMENTO = ((VARMAP_Variable_Interface<MultiBitFieldStruct>)DATA[(int)VARMAP_Variable_ID.VARMAP_ID_UNLOCKED_MEMENTO]).GetListCopy;
            _GET_SHADOW_ARRAY_UNLOCKED_MEMENTO = ((VARMAP_Variable_Interface<MultiBitFieldStruct>)DATA[(int)VARMAP_Variable_ID.VARMAP_ID_UNLOCKED_MEMENTO]).GetShadowListCopy;
            ...
            _GET_ELEM_PLAYER_ACTUAL_WAYPOINT = ((VARMAP_Variable_Interface<WaypointIdTupleStruct>)DATA[(int)VARMAP_Variable_ID.VARMAP_ID_PLAYER_ACTUAL_WAYPOINT]).GetListElem;
            _GET_SHADOW_ELEM_PLAYER_ACTUAL_WAYPOINT = ((VARMAP_Variable_Interface<WaypointIdTupleStruct>)DATA[(int)VARMAP_Variable_ID.VARMAP_ID_PLAYER_ACTUAL_WAYPOINT]).GetShadowListElem;
            _SET_ELEM_PLAYER_ACTUAL_WAYPOINT = ((VARMAP_Variable_Interface<WaypointIdTupleStruct>)DATA[(int)VARMAP_Variable_ID.VARMAP_ID_PLAYER_ACTUAL_WAYPOINT]).SetListElem;
            _GET_SIZE_PLAYER_ACTUAL_WAYPOINT = ((VARMAP_Variable_Interface<WaypointIdTupleStruct>)DATA[(int)VARMAP_Variable_ID.VARMAP_ID_PLAYER_ACTUAL_WAYPOINT]).GetListSize;
            _GET_ARRAY_PLAYER_ACTUAL_WAYPOINT = ((VARMAP_Variable_Interface<WaypointIdTupleStruct>)DATA[(int)VARMAP_Variable_ID.VARMAP_ID_PLAYER_ACTUAL_WAYPOINT]).GetListCopy;
            _GET_SHADOW_ARRAY_PLAYER_ACTUAL_WAYPOINT = ((VARMAP_Variable_Interface<WaypointIdTupleStruct>)DATA[(int)VARMAP_Variable_ID.VARMAP_ID_PLAYER_ACTUAL_WAYPOINT]).GetShadowListCopy;
            _SET_ARRAY_PLAYER_ACTUAL_WAYPOINT = ((VARMAP_Variable_Interface<WaypointIdTupleStruct>)DATA[(int)VARMAP_Variable_ID.VARMAP_ID_PLAYER_ACTUAL_WAYPOINT]).SetListValues;
            _REG_PLAYER_ACTUAL_WAYPOINT = ((VARMAP_Variable_Interface<WaypointIdTupleStruct>)DATA[(int)VARMAP_Variable_ID.VARMAP_ID_PLAYER_ACTUAL_WAYPOINT]).RegisterChangeEvent;
            _UNREG_PLAYER_ACTUAL_WAYPOINT = ((VARMAP_Variable_Interface<WaypointIdTupleStruct>)DATA[(int)VARMAP_Variable_ID.VARMAP_ID_PLAYER_ACTUAL_WAYPOINT]).UnregisterChangeEvent;
            ...
            _GET_BUSY_STATE = ((VARMAP_Variable_Interface<BusyState>)DATA[(int)VARMAP_Variable_ID.VARMAP_ID_BUSY_STATE]).GetValue;
            _GET_SHADOW_BUSY_STATE = ((VARMAP_Variable_Interface<BusyState>)DATA[(int)VARMAP_Variable_ID.VARMAP_ID_BUSY_STATE]).GetShadowValue;
