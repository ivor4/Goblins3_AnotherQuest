...
namespace Gob3AQ.VARMAP.Types.Delegates
{
    ...
    public delegate void TAKE_ITEM_EVENT_DELEGATE(GamePickableItem item);
    public delegate void RETAKE_ITEM_EVENT_DELEGATE(GamePickableItem item, bool take);
    public delegate void IS_ITEM_TAKEN_FIRST_DELEGATE(GamePickableItem item, out bool taken);
    public delegate void IS_ITEM_TAKEN_DELEGATE(GamePickableItem item, out bool taken);
    ...
    public delegate void GET_ITEM_LIST_DELEGATE(ref ReadOnlyList<ItemClass> list);
