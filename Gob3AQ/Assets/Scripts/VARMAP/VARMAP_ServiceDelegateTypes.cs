...
namespace Gob3AQ.VARMAP.Types.Delegates
{
    ...
    public delegate void ITEM_PERFORM_ANIMATION_DELEGATE(GameItem item, AnimationTrigger trigger, Action startCallback, Action endCallback, bool storeSteadyOnly);
