...
namespace Gob3AQ.ResourceDialogsAtlas
{
    public static class ResourceDialogsAtlasClass
    {
        ...
        private static readonly DialogOptionConfig[] _DialogOptionConfig = new DialogOptionConfig[(int)DialogOption.DIALOG_OPTION_TOTAL]
        {
            ...
            MomentType.MOMENT_ANY,
            new GameAction[1]{GameAction.ACTION_NONE},
            DialogType.DIALOG_ALTER_EGO_DREAM_1,false,
        ...
        private static readonly PhraseConfig[] _PhraseConfig = new PhraseConfig[(int)DialogPhrase.PHRASE_TOTAL]
        {
            ...
            new(1,GameSound.SOUND_PHRASE_DIALOG_ALTER_EGO_DREAM_1_OPTION_0_0, new AnimationTrigger[3]{AnimationTrigger.ANIMATION_TRIGGER_STEADY_ONE,AnimationTrigger.ANIMATION_TRIGGER_TALK_ONE,AnimationTrigger.ANIMATION_TRIGGER_ZERO}), /* PHRASE_DIALOG_ALTER_EGO_DREAM_1_OPTION_0_0 */ 
            new(0,GameSound.SOUND_PHRASE_DIALOG_ALTER_EGO_DREAM_1_OPTION_0_1, new AnimationTrigger[3]{AnimationTrigger.ANIMATION_TRIGGER_TALK_ONE,AnimationTrigger.ANIMATION_TRIGGER_STEADY_ONE,AnimationTrigger.ANIMATION_TRIGGER_ZERO}), /* PHRASE_DIALOG_ALTER_EGO_DREAM_1_OPTION_0_1 */ 
            new(1,GameSound.SOUND_PHRASE_DIALOG_ALTER_EGO_DREAM_1_OPTION_0_2, new AnimationTrigger[3]{AnimationTrigger.ANIMATION_TRIGGER_STEADY_ONE,AnimationTrigger.ANIMATION_TRIGGER_TALK_ONE,AnimationTrigger.ANIMATION_TRIGGER_ZERO}), /* PHRASE_DIALOG_ALTER_EGO_DREAM_1_OPTION_0_2 */ 
            new(1,GameSound.SOUND_PHRASE_DIALOG_ALTER_EGO_DREAM_1_OPTION_0_3, new AnimationTrigger[3]{AnimationTrigger.ANIMATION_TRIGGER_STEADY_ONE,AnimationTrigger.ANIMATION_TRIGGER_TALK_ONE,AnimationTrigger.ANIMATION_TRIGGER_ZERO}), /* PHRASE_DIALOG_ALTER_EGO_DREAM_1_OPTION_0_3 */ 
            new(0,GameSound.SOUND_PHRASE_DIALOG_ALTER_EGO_DREAM_1_OPTION_0_4, new AnimationTrigger[3]{AnimationTrigger.ANIMATION_TRIGGER_TALK_ONE,AnimationTrigger.ANIMATION_TRIGGER_STEADY_ONE,AnimationTrigger.ANIMATION_TRIGGER_ZERO}), /* PHRASE_DIALOG_ALTER_EGO_DREAM_1_OPTION_0_4 */ 
            new(1,GameSound.SOUND_PHRASE_DIALOG_ALTER_EGO_DREAM_1_OPTION_0_5, new AnimationTrigger[3]{AnimationTrigger.ANIMATION_TRIGGER_STEADY_ONE,AnimationTrigger.ANIMATION_TRIGGER_TALK_ONE,AnimationTrigger.ANIMATION_TRIGGER_ZERO}), /* PHRASE_DIALOG_ALTER_EGO_DREAM_1_OPTION_0_5 */ 
            new(1,GameSound.SOUND_PHRASE_DIALOG_ALTER_EGO_DREAM_1_OPTION_0_6, new AnimationTrigger[3]{AnimationTrigger.ANIMATION_TRIGGER_STEADY_ONE,AnimationTrigger.ANIMATION_TRIGGER_TALK_ONE,AnimationTrigger.ANIMATION_TRIGGER_ZERO}), /* PHRASE_DIALOG_ALTER_EGO_DREAM_1_OPTION_0_6 */ 
            new(0,GameSound.SOUND_PHRASE_DIALOG_ALTER_EGO_DREAM_1_OPTION_0_7, new AnimationTrigger[3]{AnimationTrigger.ANIMATION_TRIGGER_TALK_ONE,AnimationTrigger.ANIMATION_TRIGGER_STEADY_ONE,AnimationTrigger.ANIMATION_TRIGGER_ZERO}), /* PHRASE_DIALOG_ALTER_EGO_DREAM_1_OPTION_0_7 */ 
            new(1,GameSound.SOUND_PHRASE_DIALOG_ALTER_EGO_DREAM_1_OPTION_0_8, new AnimationTrigger[3]{AnimationTrigger.ANIMATION_TRIGGER_STEADY_ONE,AnimationTrigger.ANIMATION_TRIGGER_TALK_ONE,AnimationTrigger.ANIMATION_TRIGGER_ZERO}), /* PHRASE_DIALOG_ALTER_EGO_DREAM_1_OPTION_0_8 */ 
            new(0,GameSound.SOUND_PHRASE_DIALOG_ALTER_EGO_DREAM_1_OPTION_0_9, new AnimationTrigger[3]{AnimationTrigger.ANIMATION_TRIGGER_TALK_ONE,AnimationTrigger.ANIMATION_TRIGGER_STEADY_ONE,AnimationTrigger.ANIMATION_TRIGGER_ZERO}), /* PHRASE_DIALOG_ALTER_EGO_DREAM_1_OPTION_0_9 */ 
            new(1,GameSound.SOUND_PHRASE_DIALOG_ALTER_EGO_DREAM_1_OPTION_0_10, new AnimationTrigger[3]{AnimationTrigger.ANIMATION_TRIGGER_STEADY_ONE,AnimationTrigger.ANIMATION_TRIGGER_TALK_ONE,AnimationTrigger.ANIMATION_TRIGGER_ZERO}), /* PHRASE_DIALOG_ALTER_EGO_DREAM_1_OPTION_0_10 */ 
