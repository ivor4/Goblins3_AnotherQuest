...
namespace Gob3AQ.VARMAP
{
    ...
    public abstract class VARMAP
    {
        ...
        protected static GetVARMAPArrayElemValueDelegate<WaypointIdTupleStruct> _GET_ELEM_PLAYER_ACTUAL_WAYPOINT;
        protected static GetVARMAPArrayElemValueDelegate<WaypointIdTupleStruct> _GET_SHADOW_ELEM_PLAYER_ACTUAL_WAYPOINT;
        protected static SetVARMAPArrayElemValueDelegate<WaypointIdTupleStruct> _SET_ELEM_PLAYER_ACTUAL_WAYPOINT;
        protected static GetVARMAPArraySizeDelegate _GET_SIZE_PLAYER_ACTUAL_WAYPOINT;
        protected static GetVARMAPArrayDelegate<WaypointIdTupleStruct> _GET_ARRAY_PLAYER_ACTUAL_WAYPOINT;
        protected static GetVARMAPArrayDelegate<WaypointIdTupleStruct> _GET_SHADOW_ARRAY_PLAYER_ACTUAL_WAYPOINT;
        protected static SetVARMAPArrayDelegate<WaypointIdTupleStruct> _SET_ARRAY_PLAYER_ACTUAL_WAYPOINT;
        protected static ReUnRegisterVARMAPValueChangeEventDelegate<WaypointIdTupleStruct> _REG_PLAYER_ACTUAL_WAYPOINT;
        protected static ReUnRegisterVARMAPValueChangeEventDelegate<WaypointIdTupleStruct> _UNREG_PLAYER_ACTUAL_WAYPOINT;
        ...
        protected static GetVARMAPValueDelegate<BusyState> _GET_BUSY_STATE;
        protected static GetVARMAPValueDelegate<BusyState> _GET_SHADOW_BUSY_STATE;
