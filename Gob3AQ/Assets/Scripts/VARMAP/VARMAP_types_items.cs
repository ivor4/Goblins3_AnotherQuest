...
namespace Gob3AQ.VARMAP.Types
{
    ...
    public enum GamePickableItem
    {
        ...
        ITEM_PICK_ROOM1_CONTRACT, 
        ITEM_PICK_ROOM1_JAR, 
        ITEM_PICK_ROOM1_COIN, 
    ...
    public enum ActionConditions
    {
        ...
        COND_ROOM1_TRY_OPEN_DRAWER, 
        COND_ROOM1_USE_LOCKPICK_DRAWER, 
        COND_ROOM1_TAKE_CONTRACT, 
        COND_ROOM1_TAKE_JAR, 
        COND_ROOM1_USE_CONTRACT_WITTN3, 
        COND_ROOM1_TAKE_COIN_STUCK, 
        COND_LAST, 
    ...
    public enum UnchainConditions
    {
        ...
        UNCHAIN_ROOM1_USE_LOCKPICK_1, 
        UNCHAIN_ROOM1_USE_LOCKPICK_2, 
        UNCHAIN_ROOM1_TAKE_CONTRACT_1, 
        UNCHAIN_ROOM1_TAKE_CONTRACT_2, 
        UNCHAIN_ROOM1_TAKE_JAR, 
