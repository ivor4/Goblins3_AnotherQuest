...
namespace Gob3AQ.VARMAP.Initialization
{
    public abstract partial class VARMAP_Initialization : VARMAP
    {
        ...
        public static void InitializeDataSystem()
        {
            ...
            DATA[(int)VARMAP_Variable_ID.VARMAP_ID_ITEMS_COLLECTED] = new VARMAP_SafeArray<MultiBitFieldStruct>(VARMAP_Variable_ID.VARMAP_ID_ITEMS_COLLECTED, 2, true, MultiBitFieldStruct.StaticParseFromBytes, MultiBitFieldStruct.StaticParseToBytes, null);
