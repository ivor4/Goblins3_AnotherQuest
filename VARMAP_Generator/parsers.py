...
def process_action_conds(ctx: CodeGenContext):
    ...
    for idx, cols in enumerate(rows):
        ...
        if zone == 1:
            ...
            ctx.items_interact.insert_line(10, f"{PREFIXES['decision']}{cols[9]},{PREFIXES['moment']}{cols[10]},{PREFIXES['dialog']}{cols[11]},{PREFIXES['phrase']}{cols[12]},{PREFIXES['anim_trigger']}{cols[13]},{PREFIXES['animation']}{cols[14]},{PREFIXES['sound']}{cols[15]},{PREFIXES['room']}{cols[16]},\"{cols[17]}\",{PREFIXES['cardgame']}{cols[18]}), \n\n")
