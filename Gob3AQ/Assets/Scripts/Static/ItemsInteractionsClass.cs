...
{ 
    public static class ItemsInteractionsClass
    {
        ...
        private static readonly UnchainInfo[] _UnchainConditions = new UnchainInfo[(int)UnchainConditions.UNCHAIN_TOTAL]
        {
            ...
            new( /* UNCHAIN_UNSPAWN_KEY_SCRATCHER */
            true,false,false,new(GameEvent.EVENT_NONE, false), 
            new GameEventCombi[1]{new(GameEvent.EVENT_NONE, false)}, 
            MomentType.MOMENT_ANY, 
            ...
            new( /* UNCHAIN_RECOVER_JUG_LIQUID_VALUE */
            true,false,false,new(GameEvent.EVENT_NONE, false), 
            new GameEventCombi[1]{new(GameEvent.EVENT_NONE, false)}, 
            MomentType.MOMENT_ANY, 
        ...
        private static readonly ActionConditionsInfo[] _ActionConditions = new ActionConditionsInfo[(int)ActionConditions.COND_TOTAL]
        {
            ...
            new GameEventCombi[1]{new(GameEvent.EVENT_NONE, false)}, 
            MomentType.MOMENT_ANY,CharacterType.CHARACTER_MAIN,GameItem.ITEM_NONE,ItemInteractionType.INTERACTION_OBSERVE,"",
            new GameAction[1]{GameAction.ACTION_DIALOGUE_OBSERVE_EXPERIMENT_TABLE}), 

            new( /* COND_TAKE_EXPERIMENT_TABLE_NOT */
            new GameEventCombi[1]{new(GameEvent.EVENT_USED_IDEA_ROACHES_EXPERIMENT_TABLE, true)}, 
            MomentType.MOMENT_ANY,CharacterType.CHARACTER_MAIN,GameItem.ITEM_NONE,ItemInteractionType.INTERACTION_TAKE,"",
            ...
            new( /* COND_OBSERVE_ITEM_PICKABLE_LAB_FLOORWASHER */
            new GameEventCombi[1]{new(GameEvent.EVENT_NONE, false)}, 
            MomentType.MOMENT_ANY,CharacterType.CHARACTER_MAIN,GameItem.ITEM_NONE,ItemInteractionType.INTERACTION_OBSERVE,"",
            new GameAction[1]{GameAction.ACTION_DIALOGUE_OBSERVE_ITEM_PICKABLE_LAB_FLOORWASHER}), 

            new( /* COND_OBSERVE_ITEM_PICKABLE_LAB_DETERGENT */
            new GameEventCombi[1]{new(GameEvent.EVENT_NONE, false)}, 
            MomentType.MOMENT_ANY,CharacterType.CHARACTER_MAIN,GameItem.ITEM_NONE,ItemInteractionType.INTERACTION_OBSERVE,"",
            new GameAction[1]{GameAction.ACTION_DIALOGUE_OBSERVE_ITEM_PICKABLE_LAB_DETERGENT}), 

            new( /* COND_OBSERVE_ITEM_PICKABLE_LAB_INSECTICIDE */
            new GameEventCombi[1]{new(GameEvent.EVENT_NONE, false)}, 
            MomentType.MOMENT_ANY,CharacterType.CHARACTER_MAIN,GameItem.ITEM_NONE,ItemInteractionType.INTERACTION_OBSERVE,"",
            new GameAction[1]{GameAction.ACTION_DIALOGUE_OBSERVE_ITEM_PICKABLE_LAB_INSECTICIDE}), 

            new( /* COND_OBSERVE_ITEM_PICKABLE_LAB_VARNISH */
            new GameEventCombi[1]{new(GameEvent.EVENT_NONE, false)}, 
            MomentType.MOMENT_ANY,CharacterType.CHARACTER_MAIN,GameItem.ITEM_NONE,ItemInteractionType.INTERACTION_OBSERVE,"",
            new GameAction[1]{GameAction.ACTION_DIALOGUE_OBSERVE_ITEM_PICKABLE_LAB_VARNISH}), 

            new( /* COND_OBSERVE_ITEM_RUSTY_SPRING */
            new GameEventCombi[1]{new(GameEvent.EVENT_NONE, false)}, 
            MomentType.MOMENT_ANY,CharacterType.CHARACTER_MAIN,GameItem.ITEM_NONE,ItemInteractionType.INTERACTION_OBSERVE,"",
            new GameAction[1]{GameAction.ACTION_DIALOGUE_OBSERVE_ITEM_RUSTY_SPRING}), 
            ...
            MomentType.MOMENT_ANY,CharacterType.CHARACTER_MAIN,GameItem.ITEM_PICKABLE_HIVE_KEY_BROKEN,ItemInteractionType.INTERACTION_USE,"",
            new GameAction[1]{GameAction.ACTION_DIALOGUE_NONSENSE_NOT_THOUGHT}), 

            new( /* COND_USE_BROKEN_KEY_RUSTY_SPRING_NOT_2 */
            new GameEventCombi[1]{new(GameEvent.EVENT_SCRATCHED_RUSTY_SPRING, false)}, 
            MomentType.MOMENT_ANY,CharacterType.CHARACTER_MAIN,GameItem.ITEM_PICKABLE_HIVE_KEY_BROKEN,ItemInteractionType.INTERACTION_USE,"",
            new GameAction[1]{GameAction.ACTION_DIALOGUE_NONSENSE_NOT_THOUGHT}), 

            new( /* COND_OBSERVE_ITEM_RUST_POWDER */
            new GameEventCombi[1]{new(GameEvent.EVENT_NONE, false)}, 
            MomentType.MOMENT_ANY,CharacterType.CHARACTER_MAIN,GameItem.ITEM_NONE,ItemInteractionType.INTERACTION_OBSERVE,"",
        ...
        private static readonly MementoParentInfo[] _MementoParentInfo = new MementoParentInfo[(int)MementoParent.MEMENTO_PARENT_TOTAL]
        {
            ...
            new Memento[2]{Memento.MEMENTO_REME_1, Memento.MEMENTO_REME_2}
            ),
        ...
        private static readonly MementoInfo[] _MementoInfo = new MementoInfo[(int)Memento.MEMENTO_TOTAL]
        {
            ...
            /* MEMENTO_REME_2 */
            new(MementoParent.MEMENTO_PARENT_REME,DialogPhrase.PHRASE_MEMENTO_REME_2,false),
            /* MEMENTO_ROACHES_1 */
        ...
        private static readonly ActionInfo[] _ActionInfo = new ActionInfo[(int)GameAction.ACTION_TOTAL]
        {
            ...
            CharacterType.CHARACTER_NONE,Memento.MEMENTO_NONE,
            new GameEventCombi[1]{new(GameEvent.EVENT_NONE, false)}, 
            DecisionType.DECISION_NONE,MomentType.MOMENT_ANY,DialogType.DIALOG_NONE,DialogOption.DIALOG_OPTION_NONE,DialogPhrase.PHRASE_NONE,AnimationTrigger.ANIMATION_TRIGGER_ZERO,GameAnimation.ANIMATION_NONE,GameSound.SOUND_NONE,Room.ROOM_NONE,"",null,null,0,0,CustomFunction.CUSTOM_FUNCTION_RECOVER_LAB_MISC_VALUES,CardGameID.CARD_GAME_NONE), 

            new( /* ACTION_CUSTOM_UPDATE_JUG_LIQUID_VALUE */
            false,ActionType.ACTION_TYPE_EXEC_CUSTOM_FN,GameItem.ITEM_NONE,GameSprite.SPRITE_NONE,
            CharacterType.CHARACTER_NONE,Memento.MEMENTO_NONE,
            new GameEventCombi[1]{new(GameEvent.EVENT_NONE, false)}, 
            DecisionType.DECISION_NONE,MomentType.MOMENT_ANY,DialogType.DIALOG_NONE,DialogOption.DIALOG_OPTION_NONE,DialogPhrase.PHRASE_NONE,AnimationTrigger.ANIMATION_TRIGGER_ZERO,GameAnimation.ANIMATION_NONE,GameSound.SOUND_NONE,Room.ROOM_NONE,"",null,null,0,0,CustomFunction.CUSTOM_FUNCTION_UPDATE_JUG_LIQUID,CardGameID.CARD_GAME_NONE), 
